...
<div class="header">
    ...
    <ul class="nav user-menu">
                    ...
                    <ul class="notification-list">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
                                    <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('admin/assets/img/patients/patient1.jpg') }}">
                                    </span>
                                    <div class="media-body">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
                                    <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('admin/assets/img/patients/patient2.jpg') }}">
                                    </span>
                                    <div class="media-body">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <span class="user-img"><img class="rounded-circle" src="{{ url('admin/assets/img/profiles/avatar-01.jpg') }}" width="31" alt="Ryan Taylor"></span>
            </a>
